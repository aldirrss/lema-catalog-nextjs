  ...
  return (
    <>
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-label={t.module.purchase.title}
        style={{
          position: 'fixed',
          inset: 0,
          zIndex: 1000,
      ...
      >
        ...
        >
          ...
          <p style={{ margin: '0 0 1.25rem', fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: 1.6, paddingRight: '1.5rem' }}>
