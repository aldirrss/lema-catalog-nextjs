...
export const id: TranslationKeys = {
  ...
  hero: {
    ...
    cta: 'Jelajahi solusi Odoo kelas enterprise yang dirancang untuk bisnis modern — mulai dari keuangan, operasional, hingga HR, dengan kelincahan startup dan eksekusi berbasis produk.',
  ...
  module: {
    ...
    purchase: {
      title: 'Beli Modul',
      subtitle: 'Silakan lengkapi detail kontak Anda untuk menerima akses unduhan yang aman dan invoice resmi.',
  ...
  article: {
    title: 'Artikel',
    subtitle: 'Jelajahi basis pengetahuan kami — panduan, tutorial, dan dokumentasi.',
    searchPlaceholder: 'Cari artikel...',
    noArticles: 'Tidak ada artikel',
    noArticlesDesc: 'Belum ada artikel yang dipublikasikan. Periksa kembali nanti.',
