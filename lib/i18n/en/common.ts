...
export const en: TranslationKeys = {
  ...
  hero: {
    ...
    cta: 'Explore enterprise-grade Odoo solutions engineered for modern businesses — from finance and operations to HR, delivered with startup agility and product-first execution.',
  ...
  module: {
    ...
    purchase: {
      ...
      subtitle: 'Please share your contact details to receive secure download access and the official invoice.',
      formName: 'Full Name',
  ...
  article: {
    title: 'Articles',
    subtitle: 'Browse our knowledge base — guides, tutorials, and documentation.',
    searchPlaceholder: 'Search articles...',
    noArticles: 'No articles found',
    noArticlesDesc: 'There are no published articles yet. Check back soon.',
    cardView: 'Card View',
    listView: 'List View',
    readMore: 'Read more',
